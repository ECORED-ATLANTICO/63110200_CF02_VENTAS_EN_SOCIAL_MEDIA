    ...
    .bg-full-width.bg-fondo-1
      ...
      .row.justify-content-center.align-items-center.z-2.mb-5
        .col-lg-11(data-aos="fade-right")
          p.banner-text El cierre de ventas digitales representa una etapa estratégica dentro de los procesos comerciales desarrollados mediante plataformas digitales y redes sociales. Su importancia radica en la capacidad para transformar el interés generado durante las etapas previas en acciones concretas de adquisición. La adecuada gestión de la conversión y los medios de pago permite reducir barreras, optimizar la experiencia del consumidor y fortalecer los resultados comerciales. En las ventas en <em>social media</em>, estos elementos contribuyen directamente a la materialización de los objetivos empresariales y al fortalecimiento de relaciones comerciales sostenibles.
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in")
      .col-lg-3.col-md-6.mb-4.mb-lg-0
        .bg-color-015.p-4.br-15.h-100.text-center
          img(src="@/assets/curso/tema6/img04.svg", style="max-width: 60px;").mx-auto.mb-3
          h4.mb-3 Generación de prospectos
          p.mb-3 Permite obtener información de contacto de potenciales clientes.
          p.mb-0 <b>Ejemplo aplicado:</b> una empresa ofrece una guía gratuita a cambio del correo electrónico de personas interesadas en sus productos.
      ...
      .col-lg-3.col-md-6.mb-4.mb-lg-0
        .bg-color-015.p-4.br-15.h-100.text-center
          img(src="@/assets/curso/tema6/img06.svg", style="max-width: 60px;").mx-auto.mb-3
          h4.mb-3 Conversión comercial
          p.mb-3 Conduce a la adquisición de productos o servicios ofrecidos.
          p.mb-0 <b>Ejemplo aplicado:</b> un consumidor realiza una compra después de conocer un producto mediante una campaña en redes sociales.

      .col-lg-3.col-md-6.mb-4.mb-lg-0
        .bg-color-015.p-4.br-15.h-100.text-center
          img(src="@/assets/curso/tema6/img07.svg", style="max-width: 60px;").mx-auto.mb-3
          h4.mb-3 Fidelización
          p.mb-3 Fortalece la continuidad de la relación después de la compra.
          p.mb-0 <b>Ejemplo aplicado:</b> una empresa envía beneficios personalizados a clientes que ya realizaron una compra.
